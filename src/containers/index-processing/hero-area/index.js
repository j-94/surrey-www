...
const HeroArea = (props) => {
    const HeroData = useStaticQuery(graphql`
        query ProcessingHeroQuery {
            indexProcessingJson(id: {eq: "processing-hero-content"}) {
                ...
                bg_image {
                    childImageSharp {
                        fluid(base64Width: 1920, quality: 100) {
                            base64
                        }
                    }
                }
                image {
                    childImageSharp {
                        fluid(base64Width: 601, quality: 100) {
                            base64
                        }
                    }
                }
    ...
    return (
        <Fragment>
            <HeroWrapper style={{backgroundImage: `url(${bg_image.childImageSharp.fluid.base64})`}}>
                <Container>
                    <Row alignitems="center">
                        ...
                        <Col lg={4} md={5}>
                            <ImageBox>
                                <img src={image.childImageSharp.fluid.base64} alt="Processing" />
                            </ImageBox>
                        </Col>
                    </Row>
                </Container>
