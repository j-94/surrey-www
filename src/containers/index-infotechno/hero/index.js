    ...
    const heroDataQuery = useStaticQuery(graphql`
        query heroQueryData {
            indexInfotechnoJson(id: {eq: "infotechno-hero-content"}) {
                ...
                image1 {
                    childImageSharp {
                        fluid(base64Width: 521, quality: 100) {
                            base64
                        }
                    }
                }
                image2 {
                    childImageSharp {
                        fluid(base64Width: 706, quality: 100) {
                            base64
                        }
                ...
                <Row alignitems="center">
                    ...
                    <Col md={6}>
                        <ImageBoxWrap>
                            {image1 && (
                                <ImageBoxOne>
                                    <img src={image1.childImageSharp.fluid.base64} alt="Infotechno" />
                                </ImageBoxOne>
                            )}
                            {image2 && (
                                <ImageBoxTwo>
                                    <img src={image2.childImageSharp.fluid.base64} alt="Infotechno" />
                                </ImageBoxTwo>
                            )}
                        </ImageBoxWrap>
                    </Col>
