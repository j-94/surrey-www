    ...
    const heroData = useStaticQuery(graphql `
        query CybersecurityHeroQuery {
            indexCybersecurityJson(id: {eq: "cybersecurity-hero-content"}) {
                ...
                imageTwo {
                    childImageSharp {
                        fluid(base64Width: 513, quality: 100) {
                            base64
                        }
                    }
                }
            ...
            <Container fluid>
                <Row alignitems="center">
                    ...
                    <Col lg={6} md={5}>
                        <HeroImagesWrap>
                            <HeroImageOne>
                                <img className="worldRotate" src={imageOne.childImageSharp.fluid.base64} alt="Hero Pattern"/>
                            </HeroImageOne>
                            <HeroImageTwo>
                                <img src={imageTwo.childImageSharp.fluid.base64} alt="Hero"/>
                            </HeroImageTwo>
                        </HeroImagesWrap>
                    </Col>
                </Row>
